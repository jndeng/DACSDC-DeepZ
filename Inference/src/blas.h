...
float crossentropy_loss(float p);
float delta_crossentropy_loss(float p, float label);
float focal_loss(float p, float alpha, float gamma);
float delta_focal_loss(float p, int label, float alpha, float gamma);
float l2_loss(float t, float p);
float delta_l2_loss(float t, float p);
...
void upsample_gpu(int batch, int c, int forward, float *in, int in_w, int in_h, float *out, int out_w, int out_h);
