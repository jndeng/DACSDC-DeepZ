...
layer parse_upsample(list *options, size_params params, network *net) {
    int out_w = option_find_int(options, "out_w", params.w);
    int out_h = option_find_int(options, "out_h", params.h);
    layer l = make_upsample_layer(params.batch, params.w, params.h, params.c, out_w, out_h);
